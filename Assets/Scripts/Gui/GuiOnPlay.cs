...
namespace Morphie
{
    public class GuiOnPlay : MonoBehaviour //THIS CONTROLS ALL GUI STUFF
    { // Rename properly
        ...
        void Update()
        {
            ...
            {
                TextBoxPopUp.UpdateTextBox("abc");
            }
            if (Input.GetKeyUp(KeyCode.M))
            {
                TextBoxPopUp.textPopUpGameObject.SetActive(false);
            }
