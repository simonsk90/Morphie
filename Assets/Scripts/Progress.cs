    ...
    { // Rename properly
        ...
        void Update()
        {
            ...
            if (Input.GetKeyDown("1"))
            {
                ...
                {
                    PlayerController.SwitchShape(1);
                }
            }

            if (Input.GetKeyDown("2"))
            {
                if (PlayerController.shape == 2)
                {
                    PlayerController.UseAbility();
                }
                else
                {
                    PlayerController.SwitchShape(2);
                }
            }

            if (Input.GetKeyDown("3"))
            {
                if (PlayerController.shape == 3)
                {
                    PlayerController.UseAbility();
                }
                else
                {
                    PlayerController.SwitchShape(3);
                }
            }

            if (Input.GetKeyDown("4"))
            {
                if (PlayerController.shape == 4)
                {
                    PlayerController.UseAbility();
                }
                else
                {
                    PlayerController.SwitchShape(4);
                }
            }
        ...
        void OnGUI()
        {
            string lives = PlayerController.lives.ToString();
            ...
            GUI.BeginGroup(new Rect(0, 0, size.x - PlayerController.stamina, size.y));
